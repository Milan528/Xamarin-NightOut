...
{
    class UserViewEventFragment : Android.Support.V4.App.Fragment
    {
        ...
        private void SetUpButton()
        {
            if (LoggedUser.LoggedInUser != null)
            {
                ...
                FirebaseCommunicator.GetDatabase().Reference
                    ...
                    .EqualTo(LoggedUser.LoggedInUser.Id)
        ...
        private void OnFollowButtonClicked(object sender, EventArgs e)
        {
            if(_followButton.Text == "Follow")
            {
                ...
                localMap.Put(Resources.GetString(Resource.String.user_id_column), LoggedUser.LoggedInUser.Id);

                DatabaseReference localReference = FirebaseCommunicator.GetDatabase()
